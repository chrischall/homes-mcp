...
//
// The walk + assertion now lives in `@chrischall/mcp-utils/test`'s
// `versionSyncTest` (the fleet-wide hoist of this exact guard). If a
// future contributor registers a new version-bearing constant, just add
// the `x-release-please-version` comment to the line — it starts being
